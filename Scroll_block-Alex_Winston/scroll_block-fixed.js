...
mods = [
    ...
    T => b64ToInt("ADHMPT"[T / 920 % 6 | 0]),
    T => b64ToInt("AEHMQT"[T / 920 % 6 | 0]),
    T => -(int(T / 920) * 920) / 600,
    T => -(int(T / 920) * 920) / 800,
    T => b64ToInt("tna"[min(T / 920 | 0, 2)]),
    T => b64ToInt("tnf"[min(T / 920 | 0, 2)]),
    T => b64ToInt("tni"[min(T / 920 | 0, 2)]),
    T => b64ToInt("tnV"[min(T / 920 | 0, 2)]),
    T => b64ToInt("tta"[min(T / 920 | 0, 2)]),
    T => b64ToInt("tti"[min(T / 920 | 0, 2)]),
    T => b64ToInt("UTAMYkw"[T / 920 < 2 ? T / 920 | 0 : ((T / 920 | 0) - 2) % 5 + 2]),
    T => b64ToInt("vthlo"[min(T / 920 | 0, 4)]),
...
kickSawBass = (p, m, T) => [squareNoise(p * 16, T / 2), sqr(p * 16, .5), sawBass(p, m)][min(int(T / 920), 2)],
squareNoiseIns = (p, T) => [squareNoise(p * 64, T), sqr(p * 64, .5)][+(T / 920 > 1)],
...
insts = [
    ...
    [(T, p, n, rT) => [squareNoise(p * 64, T / 2), sqr(p * 64, .5)][+(T / 920 > 1)] * adsr(0, 0, 1, 1, T, T), 2],
    [(T, p, n, rT) => noi(T) * adsr(.5, 0, 1, 0, T, rT)],
    [(T, p, n, rT) => [squareNoise(p * 40, T / 2), sqr(p * 40, .5), sqr(p * 40, .5) > 0 ? noi(T / 4) : -.5][min(int(T / 920), 2)] * adsr(0, 0, 1, .35, T, T), 3],
    ...
    [(T, p, n, rT) => [squareNoise(p * 16, T), sqr(p * 16, .5), squareNoise(p * 128, T)][min(int(T / 920), 2)] * adsr(0, 0, 1, .6, T, T), 10],
    [(T, p, n, rT) => sqr(p * 128, .5) * (rT > 0 ? .65 : 1)],
    [(T, p, n, rT) => squareNoiseIns(p, T) * adsr(0, 0, 1, 1, T, T), 2],
    [(T, p, n, rT) => [squareNoise(p * 16, T / 2), sqr(p * 16, .5) * .95, sqr(p * 64, .5) > 0 ? noi(T / 2) * .2 : -.1, sqr(p * 64, .5) * .2][min(T / 920 | 0, 3)], 11],
    [(T, p, n, rT) => [squareNoise(p * 512, T), sqr(p * 256, .5), sqr(p * 128, .5)][min(T / 920 | 0, 2)]],
    [(T, p, n, rT) => squareNoiseIns(p, T) * 1],
    [(T, p, n, rT) => [squareNoise(p * 512, T), sqr(p * 256, .5), sqr(p * 512, .5), sqr(p * 128, .5)][min(T / 920 | 0, 3)]],
    [(T, p, n, rT) => sqr(p * 128, .5) * .65],
    [(T, p, n, rT) => sqr(p * 128, .5) * adsr(0, 0, .5, .3, T, T)],
    [(T, p, n, rT) => [squareNoise(p * 32, T), sqr(p * 32, .5), sqr(p * 32, .5) * .5][min(T / 920 | 0, 2)]],
    [(T, p, n, rT) => [squareNoise(p * 32, T) * .75, sqr(p * 32, .5) * .75, sqr(p * 32, .5) * .5][min(T / 920 | 0, 2)]],
